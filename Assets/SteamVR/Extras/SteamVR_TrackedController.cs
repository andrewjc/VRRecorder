...
public class SteamVR_TrackedController : MonoBehaviour
{
    ...
    public ControllerStateProvider controllerStateProvider;
    ...
    void Start()
    {
        if(controllerStateProvider == null)
            controllerStateProvider = new SteamVrControllerStateProvider();
    ...
    void Update()
    {
		if (controllerStateProvider.getControllerState((uint)controllerIndex, ref controllerState))
		{
